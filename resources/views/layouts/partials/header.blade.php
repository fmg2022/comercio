...
<header
  class="sticky top-0 left-0 z-20 w-full px-3 py-2 mb-2 flex items-center justify-between text-slate-200 bg-sky-800 border-b-4 border-cyan-700/30 lg:px-6">
  ...
  <nav
    ...
    <ul
      ...
      <li class="flex rounded-lg md:list-item md:grow hover:bg-white/10 has-checked:bg-white/10">
        ...
        <div
          class="-top-20 right-[10dvw] bg-sky-950 sm:absolute sm:w-[73dvw] sm:py-3 sm:bg-sky-800 sm:rounded-b-lg md:static md:w-auto md:p-0 peer-checked/search:sm:top-14 transition-all duration-300">
          <form class="p-3 flex items-center justify-center sm:p-0">
            <label
              ...
              <input type="search" name="q" placeholder="Buscar producto..."
                class="p-[9px] w-full bg-black/10 rounded-l-lg outline-none">
            </label>
      ...
      <li class="relative w-full rounded-lg hover:bg-white/10 has-checked:bg-white/10 sm:w-max">
        ...
        <div
          class="absolute -top-16 left-1/2 -translate-x-1/2 invisible w-1/2 h-max px-3 py-4 flex flex-col opacity-0 rounded-lg text-center bg-cyan-800 peer-checked/perfil:visible peer-checked/perfil:opacity-100 peer-checked/perfil:top-16 sm:inset-x-0 sm:translate-0 sm:w-max transition-all duration-300">
          @if (Route::has('login'))
            @auth
      ...
      <li class="w-full rounded-lg hover:bg-white/10 sm:w-max">
        <label for="toggle-cart" class="inline-block w-full p-3 cursor-pointer sm:py-2">
          <div class="flex items-center justify-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
<!-- carrito -->
<aside
  class="fixed top-0 -right-full z-20 w-full h-screen py-5 px-4 flex flex-col overflow-y-hidden bg-sky-900 text-white peer-checked/cart:right-0 sm:w-120 transition-all duration-300">
  ...
  <ul class="grow grid content-start gap-3 overflow-y-auto"
    ...
    <li>
      <article class="flex items-center gap-3 rounded-md bg-blue-200/20">
        <a href="#" class="p-2 text-red-400 hover:text-red-500">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32">
            <path fill="currentColor" d="M12 12h2v12h-2zm6 0h2v12h-2z" />
            <path fill="currentColor"
  ...
  <div class="flex flex-col items-center justify-center gap-3 mt-3 border-t border-slate-100/60">
