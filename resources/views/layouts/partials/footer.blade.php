<footer class="flex flex-col items-center bg-zinc-100 text-center dark:bg-gray-700 dark:text-slate-300 lg:text-left">
  <div class="container p-3">
      ...
      <ul class="flex gap-4 items-center justify-center flex-wrap">
        <li>
          <a href="#" rel="noopener noreferrer" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16.875" viewBox="0 0 256 180">
              <path fill="red"
        ...
        <li>
          <a href="#" rel="noopener noreferrer" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256">
              <g fill="none">
                <rect width="256" height="256" fill="url(#IconifyId193787c8d1f5cc0602)" rx="60" />
                <rect width="256" height="256" fill="url(#IconifyId193787c8d1f5cc0603)" rx="60" />
                <path fill="#fff"
                ...
                <defs>
                  <radialGradient id="IconifyId193787c8d1f5cc0602" cx="0" cy="0" r="1"
                  ...
                  <radialGradient id="IconifyId193787c8d1f5cc0603" cx="0" cy="0" r="1"
        ...
        <li>
          <a href="#" rel="noopener noreferrer" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24.47808764940239" viewBox="0 0 251 256">
              <path
        ...
        <li>
          <a href="#" rel="noopener noreferrer" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="27.1875" viewBox="0 0 256 290">
              <path fill="#FF004F"
    ...
    <div class="grid justify-items-center gap-x-3 sm:grid-cols-2">
      <div class="mb-6">
