...
<body class="antialiased dark:bg-slate-900 dark:text-white/50">
    <header x-data="{ open: false }"
        ...
        <nav :class="{'flex flex-1 flex-col border-b border-gray-200 dark:border-gray-600': open, 'hidden': !open}"
            class="absolute top-16 left-0 right-0 bg-slate-800 sm:static sm:flex sm:justify-between pb-4">
    ...
    <!-- Categories -->
    <aside
        class="fixed -top-full left-0 z-50 w-full h-screen overflow-auto p-8 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 transition-all duration-300 ease-in-out">
    ...
    <!-- Cart -->
    <aside
        class="fixed top-0 -right-full z-50 w-full h-screen overflow-auto p-8 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 transition-all duration-300 ease-in-out">
