...
@section('content')
  <x-sections.headerTitle classTitle="flex flex-col" class="flex justify-between items-center">
    <x-slot:textTitle>
      {{ $titleEdit }}
                          ...
                          <div class="mb-14 flex flex-col items-center text-slate-900">
                            ...
                            <div class="mb-3 text-2xl">
                              ...
                              <div>
                                ...
                                <input id="quantity{{ $orderLine->id }}" type="number" name="quantity" min="1"
                                  max="{{ $orderLine->stock }}" value="{{ $orderLine->pivot->quantity }}"
