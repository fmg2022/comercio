          ...
          <td class="relative flex justify-end">
            ...
            <div class="absolute right-1/4 z-30 hidden peer-checked/checkOption:block">
              <ul
                ...
                <li>
                  <a href="{{ route('products.show', $product->id) }}" class="flex gap-3 px-4 py-2.5">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                ...
                <li>
                  <a href="{{ route('products.edit', $product->id) }}" class="flex gap-3 px-4 py-2.5">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                          stroke-width="2">
                ...
                <li>
                  <a href="" class="flex gap-3 px-4 py-2.5">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                  ...
                  <button type="button" onclick="openModal('{{ $dialogid }}')"
                    class="flex gap-3 px-4 py-2.5 cursor-pointer">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
